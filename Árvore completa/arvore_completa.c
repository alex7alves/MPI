...
/* Autor : Alex Alves
   Programa para calculo soma em arvore com qualquer numero de processos 
   e qualquer tamanho do vetor

   execute assim :
   mpiexec -n p ./arvore_completa 1 2 3 4 5 6 7 ....
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>  
